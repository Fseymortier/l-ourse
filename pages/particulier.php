...
<section class="container_adherer">
    ...
    <div class="container_item_adherer container_item_jaune">
        ...
        <div class="item_adherer">
            <p>Afin de recevoir régulièrement des OURSES dans votre compte d'échange habituel, vous pouvez utiliser le <a class="colored_txt" href="https://framaforms.org/souscription-mensuel-d-ourse-1605090532">formulaire de souscription en ligne</a> ou le bulletin de souscription d'Ourse sur Internet par virement ponctuel ou régulier.</p>
            <a class="colored_txt" href="/documents/Bulletin_de_souscription_virement.pdf">Bulletin de souscription</a>
        </div>
    </div>
    <div class="container_item_adherer container_item_violet">
        ...
        <div class="item_adherer">
            ...
            <p><a href="/pages/carte.php" class="colored_txt">Pour les localiser</a></p>
            <p>Si vous avez repéré un prestataire près de chez vous qui souhaiterait accepter les OURSES, envoyez nous <a class="colored_txt" href="/pages/contact.php">un message ICI</a></p>
        </div>
    </div>
    <div class="container_item_adherer container_item_jaune">
        ...
        <div class="item_adherer">
            ...
            <p>C'est ici que vous pourrez échanger vos Euros en monnaie locale. Si vous avez repéré un commerce près de chez vous qui souhaiterait devenir comptoir d'échange, <a class="colored_txt" href="/pages/contact.php">envoyez nous un message ICI</a>.</p>
        </div>
    </div>
</section>
