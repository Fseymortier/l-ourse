...
<section class="container_adherer">
    ...
    <div class="container_item_adherer container_item_jaune">
        ...
        <div class="item_adherer">
            ...
            <a class="colored_txt" href="/l-ourse/documents/Bulletin_de_souscription_virement.pdf">Bulletin de souscription</a>
        </div>
    </div>
    <div class="container_item_adherer container_item_violet">
        ...
        <div class="item_adherer">
            ...
            <p><a href="/l-ourse/pages/carte.php" class="colored_txt">Pour les localiser</a></p>
            <p>Si vous avez repéré un prestataire près de chez vous qui souhaiterait accepter les OURSES, envoyez nous <a class="colored_txt" href="/l-ourse/pages/contact.php">un message ICI</a></p>
        </div>
    </div>
    <div class="container_item_adherer container_item_jaune">
